...
const reviews = [
  {
    client: "Ayesha Malik",
    product: "HerCare",
    message: "HerCare completely changed my life! I feel more energetic and balanced.",
    rating: 5,
  },
  {
    client: "Umar Shahbaz",
    product: "Diafix",
    message: "Using Diafix helped me stabilize my sugar levels naturally.",
    rating: 4,
  },
  {
    client: "Fatima Rizvi",
    product: "Uricare",
    message: "No more joint pain! Uricare works like magic. Highly recommended!",
    rating: 4.5,
  },
  {
    client: "Ali Nawaz",
    product: "Slimfit",
    message: "Slimfit helped me lose 6kg in 1 month. Great taste and results!",
    rating: 5,
  },
];
